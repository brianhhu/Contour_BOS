...
if flag
    cont_ind_x = fliplr(2:x_mult:c_len+1); % on end
else
    cont_ind_x = fliplr((c_cen(2)-x_mult*(c_len-ceil(c_len/2))):x_mult:(c_cen(2)+x_mult*(c_len-ceil(c_len/2)))); % centered
end
...
if pos_y > 0
    shift = pos_y; % how much to translate contour (3 or 6)
